          ...
          >
            <div className=" h-96 flex items-center justify-center">
              ...
              <Image
                ...
                } p-1 w-full h-96 object-cover rounded-2xl`}  width={2239}
  height={2799}
                alt={e.title}
              />
            </div>
            <div className="">
              <div style={{ display: 'flex', alignItems: 'center' }} className="px-4 py-2  text-titelCard dark:text-darkText">
                <div className="text-nowrap font-bold font-hk  text-xl">{e.title}

                </div>
                <div style={{ display: 'flex', alignItems: 'center' }} className="px-1 font-hk flex gap-1  text-gray items-center font-bold  dark:text-darkText">
