      ...
      {count.map(
        (e, i) =>
          (e.categorie === categorie || categorie === "home") && (
            ...
            style={{width:'18.5rem'}}
              key={i}
              className=" bg-white h-full  py-2 shadow-xl rounded-2xl shadow-shadowCard transition duration-300 dark:bg-darkSecondary dark:text-darkFontHero"
            >
              <div className="">
              ...
              <div className="flex justify-between flex-col">
                <div className="px-4 py-2  text-titelCard flex  items-center dark:text-darkText">
                  ...
                  <div className="px-1 flex gap-1  text-gray font-bold dark:text-darkText">
